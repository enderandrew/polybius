const levels = (function generateLevels() {
  ...
  for (let i = 1; i <= 256; i++) {
    ...
    if (i === 1) selectable = true;
      ...
      selectable = i % 2 !== 0; // Every 2nd level (3, 5, 7...)
    else if (i <= 32)
      selectable = i % 3 === 2; // Every 3rd level (17, 20, 23...)
    else if (i <= 64)
      selectable = i % 4 === 1; // Every 4th level (33, 37...)
    else if (i <= 128)
      selectable = i % 8 === 1; // Every 8th level (65, 73...)
